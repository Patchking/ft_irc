...
private:
	...
	static void pre_log(Level level) {
		switch (level) {
			break; case ALL:
				std::cout << dtg::color<dtg::GRAY, dtg::BOLD>();
			break; case DEBUG:
				std::cout << dtg::color<dtg::PURPLE, dtg::BOLD>();
			break; case LOG:
				std::cout << dtg::color<dtg::CYAN, dtg::BOLD>();
			break; case GENERAL:
				std::cout << dtg::color<dtg::BLUE, dtg::BOLD>();
